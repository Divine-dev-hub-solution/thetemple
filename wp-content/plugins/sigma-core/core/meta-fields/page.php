...
function sigmacore_page_settings_metafields() {
	add_meta_box( 'sigma_page_settings', __( 'Page Settings', 'sigma-core' ), 'sigmacore_page_settings_metafields_callback', 'page', 'side' );
}
...
function sigmacore_page_settings_metafields_callback( $post ) {
	...
	sigmacore_custom_metafield([
		...
		'description'	=>	__('Overrides the page title in the subheader. (Notice: This will not change the original page title for SEO. For this we recommend using a 3rd party plugin). Also this does not work for Archives', 'sigma-core'),
	...
	sigmacore_custom_metafield([
		...
		'options'	=>	[
			'page-sidebar-default'	=>	__('Theme Defaults (From theme options)', 'sigma-core'),
			'full-width'	=>	__('No Sidebar', 'sigma-core'),
			'left-sidebar'	=>	__('Left Sidebar', 'sigma-core'),
			'right-sidebar'	=>	__('Right Sidebar', 'sigma-core'),
		]
	]);
	sigmacore_custom_metafield([
		'type'	=>	'select',
		...
		'options'	=>	[
			'page-layout-default'	=>	__('Theme Defaults (From theme options)', 'sigma-core'),
			'container'	=>	__('Yes', 'sigma-core'),
			'container-fluid'	=>	__('No', 'sigma-core'),
		]
	]);
	sigmacore_custom_metafield([
		'type'	=>	'image',
