...
if ( ! function_exists( 'sigmacore_register_cpt_testimonial' ) ) {
	...
	function sigmacore_register_cpt_testimonial() {
        $testimonial_rewrite = !empty(maharatri_get_option('rewrite_testimonials')) ? maharatri_get_option('rewrite_testimonials') : 'testimonial';
		$labels = array(
		...
		$cpt_testimonial_args = array(
			...
			'show_in_menu'       => true,
			'query_var'          => true,
			'rewrite'            => array( 'slug' => $testimonial_rewrite ),
