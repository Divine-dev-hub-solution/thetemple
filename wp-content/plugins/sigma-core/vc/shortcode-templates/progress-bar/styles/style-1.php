		...
		<div class="sigma-progress-bar-wrapper">
			<div class="sigma-progress-bar-title-wrapper">
				...
				if ( isset( $progress_bar[ 'bar_label' ] )&& $progress_bar[ 'bar_label' ] ) {
					?>
					<span class="sigma-progress-bar-title"><?php echo esc_html( $progress_bar[ 'bar_label' ] ); ?></span>
					<?php
				}
			...
			<div class="sigma-progress-bar">
				<div class="sigma-progress-bar-inner" data-bar-value="<?php echo esc_attr( $width ); ?>"><span></span></div>
			</div>
		</div>
		<?php
	}
