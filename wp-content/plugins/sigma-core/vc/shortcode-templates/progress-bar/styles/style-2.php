...
if ( $progress_bars ) {
	foreach( $progress_bars as $progress_bar ){
		...
		<div class="sigma-progress-bar-wrapper rounded-bar">
			...
			?>
			<div class="chart" data-percent="<?php echo esc_attr( $width ); ?>" data-size="<?php echo $atts[ 'rounded_bar_size' ] ; ?>" data-track-color= "<?php echo $data_track_color; ?>" data-bar-color="<?php echo $data_bar_color; ?>" data-line-width="<?php echo $atts['bar_height']; ?>"  data-track-width="3" style="min-width:<?php echo $atts[ 'rounded_bar_size' ]; ?>px; min-height:<?php echo $atts[ 'rounded_bar_size' ]; ?>px; width:<?php echo $atts[ 'rounded_bar_size' ]; ?>px; ">
