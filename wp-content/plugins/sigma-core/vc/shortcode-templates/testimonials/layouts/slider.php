...
<?php } ?>
<div class="slick-slider testimonial-slider shortcode_slider" data-slick="<?php echo esc_attr( json_encode( $slick_options ) ); ?>">
	<?php
	while ( $the_query->have_posts() ) {
		$the_query->the_post();
		sigmacore_get_vc_shortcode_template( 'testimonials/styles/' . $atts[ 'style' ] );
	}
	/* Reset Post Data */
	wp_reset_postdata();
	?>
