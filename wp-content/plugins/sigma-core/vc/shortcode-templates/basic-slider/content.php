...
?>
<div class="basic-dot-slider sigma_shortcode-slider" data-slick="<?php echo esc_attr( json_encode( $slick_options ) ); ?>">
  <?php foreach ( $slide_lists as $slide_list ) { ?>
  <div class="slide-item">
    <p class="mb-0"><?php echo esc_html($slide_list['description']); ?></p>
  </div>
<?php } ?>
</div>
