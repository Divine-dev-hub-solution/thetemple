...
<div class="counter-box">
		...
		?>
		<h4><span class="counter"><?php echo esc_attr( $atts[ 'counter_number' ] ); ?></span><?php echo esc_html( $atts[ 'counter_value_text' ] ); ?><span class="plus-icon"><?php echo esc_html('+', 'sigma-core'); ?></span></h4>
