...
$info_link = vc_build_link( $atts['info_link'] );
$info_url = isset($info_link['url']) && !empty($info_link['url']) ? $info_link['url'] : '';
?>
          <div class="sigma_icon-block icon-block-2">
            ...
            <?php } ?>
              <a href="<?php echo esc_url($info_url); ?>" class="btn-link"><i class="far fa-arrow-right"></i></a>
            </div>
          </div>
