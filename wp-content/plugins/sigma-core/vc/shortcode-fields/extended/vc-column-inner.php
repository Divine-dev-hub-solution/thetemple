...
add_action( 'init', 'sigmacore_extend_vc_inner_column_fields', 99 );
if ( ! function_exists( 'sigmacore_extend_vc_inner_column_fields' ) ) {
	/**
	 * Inner column fields extend.
	 */
	function sigmacore_extend_vc_inner_column_fields() {
		$shortcode_fields = vc_get_shortcode( 'vc_column_inner' );
		$design_options   = array(
			array(
				'type'       => 'css_editor',
				'heading'    => esc_html__( 'CSS box for medium Devices', 'sigma-core' ),
				'param_name' => 'inner_column_css_md',
				'group'      => esc_attr__( 'Design Options', 'sigma-core' ),
			),
			array(
				'type'       => 'css_editor',
				'heading'    => esc_html__( 'CSS box for small Devices', 'sigma-core' ),
				'param_name' => 'inner_column_css_sm',
				'group'      => esc_attr__( 'Design Options', 'sigma-core' ),
			),
			array(
				'type'       => 'css_editor',
				'heading'    => esc_html__( 'CSS box for extra small Devices', 'sigma-core' ),
				'param_name' => 'inner_column_css_xs',
				'group'      => esc_attr__( 'Design Options', 'sigma-core' ),
			),
			array(
				'type'        => 'dropdown',
		...
		vc_map_update( 'vc_column_inner', $shortcode_fields );
