 ...
 * Holis shortcode.
 */
class Sigma_Vc_Holis_Shortcode_Fields
{
    /**
     * Shortcode title.
     *
    ...
    {
        $this->title = esc_html__('Holis', 'sigma-core');
        $this->handle = 'sigma_holis';
        $this->description = esc_html__('Use this shortcode to show holis.', 'sigma-core');
    ...
    function shortcode_fields()
    {
        ...
        $fields = array(
            ...
            array(
                'type' => 'dropdown',
                'heading' => __('Holis Tab Style', 'sigma-core'),
                'description' => esc_html__('Select Holis Tab Style.', 'sigma-core'),
            ...
            array(
                ...
                'description' => esc_html__('Enter the section title for holis', 'sigma-core'),
                'dependency' => array(
                    'element' => 'tabs_style',
                    'value' => 'style-5',
                ),
            ...
            array(
                ...
                'description' => esc_html__('Enter the section subtitle for holis', 'sigma-core'),
                'dependency' => array(
                    'element' => 'tabs_style',
                    'value' => 'style-5',
                ),
            ...
            array(
                'type' => 'dropdown',
                'heading' => __('Holis Style', 'sigma-core'),
            ...
            array(
                'type' => 'textfield',
                'heading' => esc_html__('Holis Count', 'sigma-core'),
                'param_name' => 'post_per_page',
                'description' => esc_html__('Enter number of holis to display.', 'sigma-core'),
                'admin_label' => true
            ),
            array(
                'type' => 'checkbox',
            ...
            array(
                'type' => 'checkbox',
                'heading' => esc_html__('Show Holi Author?', 'sigma-core'),
                'param_name' => 'show_holi_author',
                'value' => array(esc_html__('Yes', 'sigma-core') => 'true'),
                'std' => 'true',
                'description' => esc_html__('Select this checkbox to show holi author.', 'sigma-core'),
                'edit_field_class' => 'vc_col-sm-6 vc_column',
            ),
            array(
                'type' => 'checkbox',
                'heading' => esc_html__('Show Holi Date?', 'sigma-core'),
                'param_name' => 'show_holi_date',
                'value' => array(esc_html__('Yes', 'sigma-core') => 'true'),
                'std' => 'true',
                'description' => esc_html__('Select this checkbox to show holi date.', 'sigma-core'),
                'edit_field_class' => 'vc_col-sm-6 vc_column',
            ),
            array(
                'type' => 'checkbox',
                'heading' => esc_html__('Show Video Link?', 'sigma-core'),
                'param_name' => 'show_holi_video',
                'value' => array(esc_html__('Yes', 'sigma-core') => 'true'),
                'std' => 'true',
                'description' => esc_html__('Select this checkbox to show video link.', 'sigma-core'),
                'edit_field_class' => 'vc_col-sm-6 vc_column',
            ),
            array(
                'type' => 'checkbox',
                'heading' => esc_html__('Show PDF Link?', 'sigma-core'),
                'param_name' => 'show_holi_pdf',
                'value' => array(esc_html__('Yes', 'sigma-core') => 'true'),
                'std' => 'true',
                'description' => esc_html__('Select this checkbox to show pdf link.', 'sigma-core'),
                'edit_field_class' => 'vc_col-sm-6 vc_column',
            ),
            array(
                'type' => 'checkbox',
                'heading' => esc_html__('Show Audio Link?', 'sigma-core'),
                'param_name' => 'show_holi_link',
                'value' => array(esc_html__('Yes', 'sigma-core') => 'true'),
                'std' => 'true',
                'description' => esc_html__('Select this checkbox to show holi author.', 'sigma-core'),
                'edit_field_class' => 'vc_col-sm-6 vc_column',
            ...
            array(
                'type' => 'dropdown',
                'heading' => __('Audio Link Format', 'sigma-core'),
                'description' => esc_html__('Select audio link format.', 'sigma-core'),
                'param_name' => 'holi_audio_format',
                'value' => array(
                    esc_html__('Icon', 'sigma-core') => 'icon',
                    esc_html__('Player', 'sigma-core') => 'player',
                ),
                'std' => 'icon',
                'dependency' => array(
                    'element' => 'show_holi_link',
                    'value' => 'true',
                ),
            ),
            array(
    ...
    /**
     * Holis shortcode callback functions.
     */
    function shortcode_callback($atts, $content = null, $handle = '')
    {
        $default_atts = array(
            ...
            'icon_flaticon' => '',
            'post_per_page' => '',
            'holis_categories_tabs' => '',
            'post_categories' => '',
            'show_featured_image' => 'true',
            'show_holi_author' => 'true',
            'show_holi_date' => 'true',
            'show_holi_video' => 'true',
            'show_holi_pdf' => 'true',
            'show_holi_link' => 'true',
            'holi_audio_format' => 'icon',
            'post_order' => '',
            'post_orderby' => '',
            'post_slider_speed' => '',
        ...
        $tabs_category = get_terms('holis-category', $tab_cat);
        ...
        $sigma_shortcodes_class_unique = 'sigma-holis-' . mt_rand();
        ...
        $sigma_shortcodes_classes .= ' holis-layout-' . $atts['layout'];
        ...
        <div <?php echo ($atts['el_id']) ? 'id=' . esc_attr($atts["el_id"]) : ''; ?>
            ...
            <?php sigmacore_get_vc_shortcode_template('holis/content'); ?>
        </div>
        <?php
        return ob_get_clean();
    }
...
new Sigma_Vc_Holis_Shortcode_Fields();
