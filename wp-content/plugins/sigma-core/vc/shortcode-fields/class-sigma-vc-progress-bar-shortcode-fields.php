...
class Sigma_Vc_Progress_Bar_Shortcode_Fields {
	...
	function shortcode_fields() {
		$fields = array(
			array(
				'type'       => 'dropdown',
				'heading'    => __( 'Progress Style', 'sigma-core' ),
				'param_name' => 'style',
				'value'      => array(
			...
			array(
				...
				'param_name'  => 'unit',
				'description' => esc_html__( 'Enter measurement units (Example: %, px, points.)', 'sigma-core' ),
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Progress Bar Height', 'sigma-core' ),
				'param_name'  => 'bar_height',
				'description' => esc_html__( 'Enter value for bar height.(In Pixels.)', 'sigma-core' ),
				'admin_label' => true,
			),
			array(
				'type'        => 'textfield',
				'heading'     => esc_html__( 'Track Width', 'sigma-core' ),
				'param_name'  => 'circle_bar_height',
				'description' => esc_html__( 'Enter value for bar height.(In Pixels.)', 'sigma-core' ),
				'admin_label' => true,
				'dependency'  => array(
					'element' => 'style',
			...
			array(
				...
				'value' => array(
					...
					esc_html__( 'Pe Icon', 'sigma-core' )       => 'pe-icon-7-stroke',
				),
				'admin_label' => true,
			...
			array(
				'type'        => 'colorpicker',
				'heading'     => esc_html__( 'Bar color', 'sigma-core' ),
				'param_name'  => 'bar_color',
				'description' => esc_html__( 'Select custom single bar background color.', 'sigma-core' ),
			),
			array(
				'type'        => 'colorpicker',
				'heading'     => esc_html__( 'Bar Background Color', 'sigma-core' ),
	...
	function shortcode_callback( $atts, $content = null, $handle = '' ) {
		...
		if ( $atts[ 'bar_color' ] ) {
			$inline_css .= "." . $sigma_shortcodes_class_unique . " .sigma-progress-bar-inner {";
			if ( $atts[ 'bar_color' ] ) {
				$inline_css .= "background-color: " . $atts[ 'bar_color' ] . ";";
			}
			$inline_css .= "}";
		}
