 ...
 * Events shortcode.
 */
class Sigma_Vc_Events_Shortcode_Fields {
    /**
     * Shortcode title.
     *
     * @since 1.0.0
    ...
    function __construct() {
        $this->title         = esc_html__( 'Events', 'sigma-core' );
        $this->handle        = 'sigma_events';
        $this->description   = esc_html__( 'Use this shortcode to show events.', 'sigma-core' );
    ...
    function shortcode_fields() {
        ...
        $fields = array(
            ...
            array(
                'type'        => 'dropdown',
                'heading'     => __( 'Events Tab Style', 'sigma-core' ),
                'description' => esc_html__( 'Select Events Tab Style.', 'sigma-core' ),
            ...
            array(
                ...
                'description' => esc_html__( 'Enter the section title for events', 'sigma-core' ),
                'dependency' => array(
                    'element' => 'tabs_style',
                    'value'   => 'style-5',
                ),
            ...
            array(
                ...
                'description' => esc_html__( 'Enter the section subtitle for events', 'sigma-core' ),
                'dependency' => array(
                    'element' => 'tabs_style',
                    'value'   => 'style-5',
                ),
            ...
            array(
                'type'        => 'dropdown',
                'heading'     => __( 'Events Style', 'sigma-core' ),
            ...
            array(
                'type'        => 'textfield',
                'heading'     => esc_html__( 'Events Count', 'sigma-core' ),
                'param_name'  => 'post_per_page',
                'description' => esc_html__( 'Enter number of events to display.', 'sigma-core' ),
                'admin_label' => true
            ),
            array(
                'type'        => 'checkbox',
    ...
    /**
     * Events shortcode callback functions.
     */
    function shortcode_callback( $atts, $content = null, $handle = '' ) {
        ...
        $tabs_category = get_terms('events-category', $tab_cat);
        ...
        $sigma_shortcodes_class_unique              = 'sigma-events-' . mt_rand();
        ...
        $sigma_shortcodes_classes                   .= ' events-layout-' . $atts[ 'layout' ];
        ...
        <div <?php echo ( $atts[ 'el_id' ] ) ? 'id=' . esc_attr( $atts[ "el_id" ] ) : ''; ?> class="<?php echo esc_attr( $sigma_shortcodes_classes ); ?>">
            <?php sigmacore_get_vc_shortcode_template( 'events/content' ); ?>
        </div>
        <?php
        return ob_get_clean();
    }
}
new Sigma_Vc_Events_Shortcode_Fields();
