...
class Sigma_Vc_Products_Shortcode_Fields {
    ...
    function shortcode_fields() {
        $fields = array(
            ...
            array(
                'type'             => 'checkbox',
                'heading'          => esc_html__( 'Show Featured Badge', 'sigma-core' ),
            ...
            array(
                'type'             => 'checkbox',
                'heading'          => esc_html__( 'Show Sale', 'sigma-core' ),
            ...
            array(
                'type'             => 'checkbox',
                'heading'          => esc_html__( 'Show Ratings', 'sigma-core' ),
    ...
    function shortcode_callback( $atts, $content = null, $handle = '' ) {
        ...
        // Initialize $tabs_category to avoid undefined variable warning
        $tabs_category = array();

        if ( ! empty( $atts[ 'post_categories' ] ) ) {
        ...
        $sigma_shortcodes_classes .= ' products-layout-' . $atts['layout'];
