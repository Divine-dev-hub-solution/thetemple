  ...
  <div class="sigma_donation-body">
    ...
    <div class="sigma_donation_footer">
      ...
      <div class="progress-rounded">
				<div class="progress-value"><?php print esc_html($progress); ?>%</div>
  				<svg>
  					<circle class="progress-cicle-sm" cx="40" cy="40" r="37" stroke-width="6"
  							fill="none" aria-valuenow="<?php print esc_attr($progress); ?>" aria-orientation="vertical" role="slider" aria-valuemin="0" aria-valuemax="100"/>
  				</svg>
			</div>
    </div>
  </div>
