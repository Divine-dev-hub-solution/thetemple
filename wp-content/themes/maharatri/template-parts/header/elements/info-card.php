...
$contact_map_link = maharatri_get_option('contact_map_link');
$contact_description = maharatri_get_option('contact_description');
?>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="infocard-wrapper text-center">
        <?php
        // Logo
        maharatri_get_site_logo('info_card_logo', false);
        if(maharatri_get_option('display_info_card_description') && !empty($contact_description)){
        ?>
    ...
    <div class="col-sm-6">
      <div class="contact-details">
        <?php if(maharatri_get_option('display_info_card_phone') && !empty($contact_phone)){ ?>
          <div class="contact-item">
            ...
            <div class="contact-item-body">
              <p> <strong><?php esc_html_e('Call Us:', 'maharatri') ?></strong></p>
              <p> <?php echo esc_html($contact_phone) ?></p>
            </div>
          </div>
        <?php } ?>
        <?php if(maharatri_get_option('display_info_card_email') && !empty($contact_email)){ ?>
          <div class="contact-item">
            ...
            <div class="contact-item-body">
              <p> <strong><?php esc_html_e('Email:', 'maharatri') ?></strong></p>
              <p><a href="mailto:<?php echo esc_attr($contact_email) ?>"><?php echo esc_html($contact_email) ?></a></p>
            </div>
          </div>
        <?php } ?>
        <?php if(maharatri_get_option('display_info_card_address') && !empty($contact_address)){ ?>
        <div class="contact-item">
          ...
          <div class="contact-item-body">
            ...
            <?php if(maharatri_get_option('display_info_card_map') && !empty($contact_map_link)){ ?>
              <p>
                <a href="<?php echo esc_url($contact_map_link) ?>" target="_blank" class="map-link">
                  <span> <?php esc_html_e('Open in Google Maps', 'maharatri') ?> </span>
                </a>
              </p>
            <?php } ?>
          </div>
      ...
      <?php
      // Social info
      if(maharatri_get_option('display_info_card_socials')){
