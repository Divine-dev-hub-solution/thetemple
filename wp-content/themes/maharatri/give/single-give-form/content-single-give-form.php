...
?>
	...
	<div id="give-form-<?php the_ID(); ?>-content" <?php post_class('sigma_donation-details'); ?>>
		...
		<div class="<?php echo apply_filters( 'give_forms_single_summary_classes', 'summary entry-summary give-single-details' ); ?>">
