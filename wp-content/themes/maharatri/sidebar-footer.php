 ...
 * @visible true
 */
$footer_layout = maharatri_get_option('footer_layout', '');
if ( $footer_layout ) {
	if ( '6-6' === $footer_layout ) {
		...
		$footer_columns_classes = array( 'col-xl-4 col-lg-4 col-md-6 col-sm-12', 'col-xl-2 col-lg-2 col-md-6 col-sm-12', 'col-xl-2 col-lg-2 col-md-6 col-sm-12', 'col-xl-4 col-lg-4 col-md-6 col-sm-12' );
	}
}
else{
	$footer_columns_classes = array( 'col-xl-3 col-lg-3 col-md-6 col-sm-12', 'col-xl-3 col-lg-3 col-md-6 col-sm-12', 'col-xl-3 col-lg-3 col-md-6 col-sm-12', 'col-xl-3 col-lg-3 col-md-6 col-sm-12' );
