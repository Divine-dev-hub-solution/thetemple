...
$args = array(
	...
	'menu_title'           => sprintf( esc_html__( '%s - Theme Options', 'maharatri' ), $theme->get( 'Name' ) ),
	/* Translators: %s: Theme Name. */
	'page_title'           => sprintf( esc_html__( '%s - Theme Options', 'maharatri' ), $theme->get( 'Name' ) ),
	'google_api_key'       => '',
	...
	'global_variable'      => 'maharatri_options',
	'dev_mode'             => false,
	'update_notice'        => true,
	'customizer'           => true,
	'page_priority'        => null,
	...
	'menu_icon'            => get_template_directory_uri() . '/assets/images/theme-options.png',
	'last_tab'             => '',
	'page_icon'            => 'icon-themes',
	'page_slug'            => 'maharatri-options',
	'save_defaults'        => true,
	'default_show'         => false,
	'default_mark'         => '',
	...
	'output_tag'           => true,
	'database'             => '',
	'templates_path'       => get_template_directory() .'/inc/redux-options/templates/panel/',
	'use_cdn'              => true,
	'hints'                => array(
...
$options_files = array(
	...
	get_template_directory() . '/inc/redux-options/options/button-settings.php',
	get_template_directory() . '/inc/redux-options/options/custom-post-type-settings.php',
	get_template_directory() . '/inc/redux-options/options/volunteer-settings.php',
	get_template_directory() . '/inc/redux-options/options/service-settings.php',
	get_template_directory() . '/inc/redux-options/options/events-settings.php',
	get_template_directory() . '/inc/redux-options/options/puja-settings.php',
	get_template_directory() . '/inc/redux-options/options/holis-settings.php',
  get_template_directory() . '/inc/redux-options/options/rewrite-rules-settings.php',
	...
	get_template_directory() . '/inc/redux-options/options/additional-settings.php',
);
$options_files = apply_filters( 'maharatri_redux_option_files', $options_files );
foreach ( $options_files as $option_file ) {
	if ( file_exists( $option_file ) ) {
		...
		if ( $option_data && is_array( $option_data ) ) {
			Redux::setSection( 'maharatri_options', $option_data );
		}
	}
}
